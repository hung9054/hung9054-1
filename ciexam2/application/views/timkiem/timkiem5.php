	...
	<head>
			...
			<script type="text/javascript">
					...
					jQuery(document).ready(function($) {
						...
						$('#menu ul li:nth-child(3) a').addClass('selected').removeAttr('href').css({
							...
							$('#left-menu ul li:nth-child(5) a').addClass('left_select');
							$('#livesearch a').live('click', function(event) {
								/* Act on the event */
								$('#q').val($(this).text());
								$('#livesearch').hide();
							});
			...
			<script language="javascript">
				...
				function showResult(id)
				{
					...
					http.open('get','http://localhost/ciexam2/timkiem/ajax_level3/'+id,true);
		...
		<article>
			...
			<div id="content">
				<div id="timkiem1">
				    ...
				    <input id="q" name="q" type="text" size="30" onkeyup="showResult(this.value)">
